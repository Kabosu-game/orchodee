<?php
/**
 * Retour PayPal pour l'inscription "Registration for the Next Session".
 * Capture la commande PayPal et met à jour l'inscription en "completed".
 */
...
// Get PayPal config and capture the order
$paypalConfig = null;
