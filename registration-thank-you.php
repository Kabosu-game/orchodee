...
$stmt = $conn->prepare("SELECT * FROM session_registrations WHERE id = ?");
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Thank You - Registration Complete - Orchidee LLC</title>
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="bg-white rounded shadow-sm p-5 text-center wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <h4 class="mb-4">Your Registration Has Been Received</h4>
                            ...
                            <div class="alert alert-info text-start mb-4">
                                ...
                                <p class="mb-2"><strong>Session Duration:</strong> <?php echo htmlspecialchars($registration['session_duration']); ?></p>
                                <p class="mb-2"><strong>Total Amount:</strong> $<?php echo number_format($registration['total_amount'], 2); ?></p>
                                <p class="mb-0"><strong>Payment Status:</strong> 
                                    <span class="badge bg-<?php echo $registration['payment_status'] == 'completed' ? 'success' : 'warning'; ?>">
                            ...
                            <?php if ($registration['payment_status'] == 'pending'): ?>
                                <div class="alert alert-warning mb-4">
                                    ...
                                    <strong>Payment Pending:</strong> Your payment is being processed. You will receive an email confirmation once your payment is verified and your registration is confirmed.
                                </div>
                            <?php else: ?>
                                <div class="alert alert-success mb-4">
                                    <i class="fa fa-check me-2"></i>
                                    <strong>Payment Confirmed:</strong> Your registration has been confirmed! You will receive further instructions via email.
                                </div>
                            <?php endif; ?>

                            <div class="mb-4">
                                <p class="text-muted">
                                    We have received your registration for the <?php echo htmlspecialchars($registration['session_duration']); ?> session. 
